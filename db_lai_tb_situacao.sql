...
CREATE TABLE `tb_situacao` (
  `id_situacao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria tabela situação',
  `nome_situacao` varchar(200) DEFAULT NULL COMMENT 'descrição da situação do pedido',
...
INSERT INTO `tb_situacao` VALUES (1,'Tm Tramitação'),(2,'Tsclarecimentos Adicionais'),(3,'Tão respondido'),(4,'Tespondido');
