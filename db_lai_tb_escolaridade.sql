...
CREATE TABLE `tb_escolaridade` (
  `id_escolaridade` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria -  Tabala escolaridade',
  `nome_escolaridade` varchar(200) DEFAULT NULL COMMENT 'grau de escolaridade do solicitante',
...
INSERT INTO `tb_escolaridade` VALUES (1,'Tnsino Fundamental'),(2,'Tnsino Médio'),(3,'Tnsino Superior'),(4,'Testrado/Doutorado'),(5,'Tão se aplica'),(6,'Tós-graduação'),(7,'Tem instrução formal');
...
-- Dump completed on 2016-12-13 10:49:31
